  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="relative text-center">
        ...
        <div className="font-ubuntuc block absolute ml-10 left-0 top-1/3 text-white font-bold tracking-wider text-4xl uppercase opacity-90">Advanced Poker Strategy</div>
        <p className="font-oxygen black absolute text-left text-lg ml-10 w-2/3 left-0 top-1/2 text-white opacity-90">
